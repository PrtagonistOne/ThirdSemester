...
namespace Problem_5
{
    class Program
    {
        static void Main()
        {
            ...
            string w2 = Console.ReadLine();            // Вводим массивы для сравнения

            char[] word1 = new char[w1.Length];
            char[] word2 = new char[w2.Length];  //создаем массивы типа char
            ...
            {
                word2[i] = w2[i];
            }  //заполняем массивы типа char введеными значениями
            int m;
